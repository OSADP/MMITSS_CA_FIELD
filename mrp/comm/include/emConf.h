...
{   
  ...
  class configEm
  {
    private:      
      bool configSucceed;
      EMconfig::SocketConfig        mSocketConfig;
      EMconfig::VinConfig           mVinConfig;
    ...
    public:
      ...
      struct EMconfig::VinConfig getVinConfig(void) const;
      socketUtils::socketAddress_t getSocketAddr(const EMconfig::socketHandleEnum_t::socketHandle type) const;
  };
};
