...
{   
  struct SocketConfig
  {
    ...
    std::string s_dispSendSocket;           // to in-vehicle display
  };
  ...
  {
    enum socketHandle{WMELISTEN,WMESEND,DISPSEND};
  };
  ...
  class configObu
  {
    private:      
      bool configSucceed;
      OBUconfig::SocketConfig       mSocketConfig;
      OBUconfig::VinConfig          mVinConfig;
      socketUtils::socketAddress_t* mpWMElistenAddr;
      socketUtils::socketAddress_t* mpWMEsendAddr;
      socketUtils::socketAddress_t* mpDISPsendAddr;
    ...
    public:
      ...
      struct OBUconfig::VinConfig getVinConfig(void) const;
      socketUtils::socketAddress_t getSocketAddr(const OBUconfig::socketHandleEnum_t::socketHandle type) const;
  };
};
