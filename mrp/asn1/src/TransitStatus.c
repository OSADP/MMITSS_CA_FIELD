...
asn_dec_rval_t
TransitStatus_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TransitStatus_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TransitStatus_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	TransitStatus_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
TransitStatus_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	TransitStatus_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_TransitStatus_constr_1 GCC_NOTUSED = {
	...
	{ APC_CONSTRAINED,	 0,  0,  6l,  6l }	/* (SIZE(6..6)) */,
...
asn_TYPE_descriptor_t asn_DEF_TransitStatus = {
	...
	TransitStatus_decode_uper,
	TransitStatus_encode_uper,
	TransitStatus_decode_aper,
	TransitStatus_encode_aper,
