...
asn_enc_rval_t
AmbientAirTemperature_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	AmbientAirTemperature_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
AmbientAirTemperature_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	AmbientAirTemperature_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_AmbientAirTemperature_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8,  0l,  191l }	/* (0..191) */,
...
asn_TYPE_descriptor_t asn_DEF_AmbientAirTemperature = {
	...
	AmbientAirTemperature_decode_aper,
	AmbientAirTemperature_encode_aper,
