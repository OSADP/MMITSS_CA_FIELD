...
asn_dec_rval_t
EssMobileFriction_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EssMobileFriction_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EssMobileFriction_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	EssMobileFriction_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
EssMobileFriction_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	EssMobileFriction_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_EssMobileFriction_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0l,  101l }	/* (0..101) */,
...
asn_TYPE_descriptor_t asn_DEF_EssMobileFriction = {
	...
	EssMobileFriction_decode_uper,
	EssMobileFriction_encode_uper,
	EssMobileFriction_decode_aper,
	EssMobileFriction_encode_aper,
