...
asn_dec_rval_t
DOffset_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DOffset_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DOffset_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	DOffset_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
DOffset_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	DOffset_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_DOffset_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 11,  11, -840l,  840l }	/* (-840..840) */,
