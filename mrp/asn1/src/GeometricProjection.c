...
static asn_TYPE_member_t asn_MBR_regional_6[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_RegionalExtension_92P37,
...
static asn_TYPE_member_t asn_MBR_GeometricProjection_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_GeometricProjection_specs_1 = {
