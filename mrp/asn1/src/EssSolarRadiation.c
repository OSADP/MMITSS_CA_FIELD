...
asn_dec_rval_t
EssSolarRadiation_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EssSolarRadiation_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EssSolarRadiation_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	EssSolarRadiation_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
EssSolarRadiation_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	EssSolarRadiation_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_EssSolarRadiation_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_EssSolarRadiation = {
	...
	EssSolarRadiation_decode_uper,
	EssSolarRadiation_encode_uper,
	EssSolarRadiation_decode_aper,
	EssSolarRadiation_encode_aper,
