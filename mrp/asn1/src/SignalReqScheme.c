...
asn_dec_rval_t
SignalReqScheme_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SignalReqScheme_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SignalReqScheme_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	SignalReqScheme_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
SignalReqScheme_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	SignalReqScheme_1_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_SignalReqScheme = {
	...
	SignalReqScheme_decode_uper,
	SignalReqScheme_encode_uper,
	SignalReqScheme_decode_aper,
	SignalReqScheme_encode_aper,
