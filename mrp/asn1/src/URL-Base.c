...
asn_dec_rval_t
URL_Base_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
URL_Base_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
URL_Base_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	URL_Base_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
URL_Base_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	URL_Base_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_URL_Base_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0l,  127l }	/* (0..127) */,
	{ APC_CONSTRAINED,	 6,  6,  1l,  45l }	/* (SIZE(1..45)) */,
...
asn_TYPE_descriptor_t asn_DEF_URL_Base = {
	...
	URL_Base_decode_xer,
	URL_Base_encode_xer,
	URL_Base_decode_uper,
	URL_Base_encode_uper,
	URL_Base_decode_aper,
	URL_Base_encode_aper,
