...
asn_enc_rval_t
Heading_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	Heading_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
Heading_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	Heading_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_Heading_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 15,  15,  0l,  28800l }	/* (0..28800) */,
