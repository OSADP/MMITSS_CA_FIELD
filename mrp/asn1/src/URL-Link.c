...
asn_dec_rval_t
URL_Link_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
URL_Link_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
URL_Link_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	URL_Link_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
URL_Link_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	URL_Link_1_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_URL_Link = {
	...
	URL_Link_decode_xer,
	URL_Link_encode_xer,
	URL_Link_decode_uper,
	URL_Link_encode_uper,
	URL_Link_decode_aper,
	URL_Link_encode_aper,
