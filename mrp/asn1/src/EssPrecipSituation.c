...
asn_dec_rval_t
EssPrecipSituation_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EssPrecipSituation_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EssPrecipSituation_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	EssPrecipSituation_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
EssPrecipSituation_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	EssPrecipSituation_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_EssPrecipSituation_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0l,  14l }	/* (0..14) */,
...
static const asn_INTEGER_specifics_t asn_SPC_EssPrecipSituation_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_EssPrecipSituation = {
	...
	EssPrecipSituation_encode_uper,
	EssPrecipSituation_decode_aper,
	EssPrecipSituation_encode_aper,
