...
asn_dec_rval_t
CoefficientOfFriction_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
CoefficientOfFriction_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
CoefficientOfFriction_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	CoefficientOfFriction_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
CoefficientOfFriction_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	CoefficientOfFriction_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_CoefficientOfFriction_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0l,  50l }	/* (0..50) */,
...
asn_TYPE_descriptor_t asn_DEF_CoefficientOfFriction = {
	...
	CoefficientOfFriction_decode_uper,
	CoefficientOfFriction_encode_uper,
	CoefficientOfFriction_decode_aper,
	CoefficientOfFriction_encode_aper,
