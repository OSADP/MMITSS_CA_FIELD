...
asn_dec_rval_t
TravelerInfoType_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TravelerInfoType_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TravelerInfoType_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	TravelerInfoType_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
TravelerInfoType_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	TravelerInfoType_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_TravelerInfoType_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_TravelerInfoType_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_TravelerInfoType = {
	...
	TravelerInfoType_decode_uper,
	TravelerInfoType_encode_uper,
	TravelerInfoType_decode_aper,
	TravelerInfoType_encode_aper,
