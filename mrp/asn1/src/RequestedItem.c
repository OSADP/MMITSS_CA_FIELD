...
asn_enc_rval_t
RequestedItem_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	RequestedItem_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
RequestedItem_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	RequestedItem_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_RequestedItem_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  5,  5,  0l,  16l }	/* (0..16,...) */,
...
static const asn_INTEGER_specifics_t asn_SPC_RequestedItem_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_RequestedItem = {
	...
	RequestedItem_decode_aper,
	RequestedItem_encode_aper,
