...
static asn_per_constraints_t asn_PER_type_NodeOffsetPointLL_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0l,  7l }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_NodeOffsetPointLL_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NodeOffsetPointLL, choice.regional),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RegionalExtension_92P46,
		0,	/* Defer constraints checking to the member type */
		0,	/* No PER visible constraints */
		0,
		"regional"
...
static asn_CHOICE_specifics_t asn_SPC_NodeOffsetPointLL_specs_1 = {
