...
asn_dec_rval_t
Count_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Count_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Count_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	Count_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
Count_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	Count_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_Count_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0l,  32l }	/* (0..32) */,
