...
asn_dec_rval_t
TireLeakageRate_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TireLeakageRate_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TireLeakageRate_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	TireLeakageRate_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
TireLeakageRate_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	TireLeakageRate_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_TireLeakageRate_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 16,  16,  0l,  64255l }	/* (0..64255) */,
...
asn_TYPE_descriptor_t asn_DEF_TireLeakageRate = {
	...
	TireLeakageRate_decode_uper,
	TireLeakageRate_encode_uper,
	TireLeakageRate_decode_aper,
	TireLeakageRate_encode_aper,
