...
Longitude_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
	...
	if((value >= -1799999999LL && value <= 1800000001LL)) {
...
asn_enc_rval_t
Longitude_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	Longitude_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
Longitude_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	Longitude_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_Longitude_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 32, -1, -1799999999l,  1800000001l }	/* (-1799999999..1800000001) */,
...
asn_TYPE_descriptor_t asn_DEF_Longitude = {
	...
	Longitude_decode_aper,
	Longitude_encode_aper,
