...
asn_dec_rval_t
CodeWord_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
CodeWord_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
CodeWord_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	CodeWord_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
CodeWord_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	CodeWord_1_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_CodeWord = {
	...
	CodeWord_decode_xer,
	CodeWord_encode_xer,
	CodeWord_decode_uper,
	CodeWord_encode_uper,
	CodeWord_decode_aper,
	CodeWord_encode_aper,
