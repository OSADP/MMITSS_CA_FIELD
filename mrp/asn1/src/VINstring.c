...
asn_dec_rval_t
VINstring_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VINstring_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VINstring_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	VINstring_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
VINstring_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	VINstring_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_VINstring_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1l,  17l }	/* (SIZE(1..17)) */,
...
asn_TYPE_descriptor_t asn_DEF_VINstring = {
	...
	VINstring_decode_uper,
	VINstring_encode_uper,
	VINstring_decode_aper,
	VINstring_encode_aper,
