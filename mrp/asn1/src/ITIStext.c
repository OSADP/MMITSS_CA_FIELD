...
asn_dec_rval_t
ITIStext_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ITIStext_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ITIStext_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	ITIStext_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
ITIStext_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	ITIStext_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_ITIStext_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0l,  127l }	/* (0..127) */,
	{ APC_CONSTRAINED,	 9,  9,  1l,  500l }	/* (SIZE(1..500)) */,
...
asn_TYPE_descriptor_t asn_DEF_ITIStext = {
	...
	ITIStext_decode_xer,
	ITIStext_encode_xer,
	ITIStext_decode_uper,
	ITIStext_encode_uper,
	ITIStext_decode_aper,
	ITIStext_encode_aper,
