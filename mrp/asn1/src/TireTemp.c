...
asn_dec_rval_t
TireTemp_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TireTemp_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TireTemp_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	TireTemp_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
TireTemp_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	TireTemp_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_TireTemp_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 16,  16, -8736l,  55519l }	/* (-8736..55519) */,
...
asn_TYPE_descriptor_t asn_DEF_TireTemp = {
	...
	TireTemp_decode_xer,
	TireTemp_encode_xer,
	TireTemp_decode_uper,
	TireTemp_encode_uper,
	TireTemp_decode_aper,
	TireTemp_encode_aper,
