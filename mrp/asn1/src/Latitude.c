...
Latitude_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
	...
	if((value >= -900000000LL && value <= 900000001LL)) {
...
asn_enc_rval_t
Latitude_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	Latitude_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
Latitude_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	Latitude_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_Latitude_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 31, -1, -900000000l,  900000001l }	/* (-900000000..900000001) */,
...
asn_TYPE_descriptor_t asn_DEF_Latitude = {
	...
	Latitude_decode_aper,
	Latitude_encode_aper,
