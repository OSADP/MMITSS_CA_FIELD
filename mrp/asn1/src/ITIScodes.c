...
asn_enc_rval_t
ITIScodes_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	ITIScodes_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
ITIScodes_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	ITIScodes_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_ITIScodes_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 17, -1,  0l,  65565l }	/* (0..65565) */,
...
asn_TYPE_descriptor_t asn_DEF_ITIScodes = {
	...
	ITIScodes_decode_aper,
	ITIScodes_encode_aper,
