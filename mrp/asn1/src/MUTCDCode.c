...
asn_enc_rval_t
MUTCDCode_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	MUTCDCode_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
MUTCDCode_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	MUTCDCode_1_inherit_TYPE_descriptor(td);
...
static const asn_INTEGER_specifics_t asn_SPC_MUTCDCode_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_MUTCDCode = {
	...
	MUTCDCode_decode_aper,
	MUTCDCode_encode_aper,
