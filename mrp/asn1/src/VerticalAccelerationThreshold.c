...
asn_dec_rval_t
VerticalAccelerationThreshold_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VerticalAccelerationThreshold_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VerticalAccelerationThreshold_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	VerticalAccelerationThreshold_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
VerticalAccelerationThreshold_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	VerticalAccelerationThreshold_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_VerticalAccelerationThreshold_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  5l,  5l }	/* (SIZE(5..5)) */,
...
asn_TYPE_descriptor_t asn_DEF_VerticalAccelerationThreshold = {
	...
	VerticalAccelerationThreshold_decode_uper,
	VerticalAccelerationThreshold_encode_uper,
	VerticalAccelerationThreshold_decode_aper,
