...
asn_enc_rval_t
TimeConfidence_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	TimeConfidence_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
TimeConfidence_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	TimeConfidence_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_TimeConfidence_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0l,  39l }	/* (0..39) */,
