...
asn_enc_rval_t
Extent_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	Extent_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
Extent_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	Extent_1_inherit_TYPE_descriptor(td);
...
static const asn_INTEGER_specifics_t asn_SPC_Extent_specs_1 = {
