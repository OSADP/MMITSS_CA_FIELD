...
asn_dec_rval_t
DrivingWheelAngle_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DrivingWheelAngle_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DrivingWheelAngle_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	DrivingWheelAngle_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
DrivingWheelAngle_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	DrivingWheelAngle_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_DrivingWheelAngle_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 8,  8, -128l,  127l }	/* (-128..127) */,
...
asn_TYPE_descriptor_t asn_DEF_DrivingWheelAngle = {
	...
	DrivingWheelAngle_decode_uper,
	DrivingWheelAngle_encode_uper,
	DrivingWheelAngle_decode_aper,
	DrivingWheelAngle_encode_aper,
