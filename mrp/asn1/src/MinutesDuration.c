...
asn_dec_rval_t
MinutesDuration_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
MinutesDuration_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
MinutesDuration_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	MinutesDuration_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
MinutesDuration_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	MinutesDuration_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_MinutesDuration_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 15,  15,  0l,  32000l }	/* (0..32000) */,
...
asn_TYPE_descriptor_t asn_DEF_MinutesDuration = {
	...
	MinutesDuration_encode_uper,
	MinutesDuration_decode_aper,
	MinutesDuration_encode_aper,
