...
static asn_per_constraints_t asn_PER_type_NodeSetLL_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  2l,  63l }	/* (SIZE(2..63)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_NodeSetLL_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_NodeSetLL_specs_1 = {
