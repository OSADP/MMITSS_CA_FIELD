...
asn_dec_rval_t
PayloadData_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PayloadData_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
PayloadData_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	PayloadData_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
PayloadData_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	PayloadData_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_PayloadData_constr_1 GCC_NOTUSED = {
	...
	{ APC_CONSTRAINED,	 11,  11,  1l,  2048l }	/* (SIZE(1..2048)) */,
...
asn_TYPE_descriptor_t asn_DEF_PayloadData = {
	...
	PayloadData_decode_uper,
	PayloadData_encode_uper,
	PayloadData_decode_aper,
	PayloadData_encode_aper,
