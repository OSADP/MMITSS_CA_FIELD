...
asn_dec_rval_t
ResponderGroupAffected_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ResponderGroupAffected_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ResponderGroupAffected_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	ResponderGroupAffected_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
ResponderGroupAffected_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	ResponderGroupAffected_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_ResponderGroupAffected_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_ResponderGroupAffected_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ResponderGroupAffected = {
	...
	ResponderGroupAffected_decode_uper,
	ResponderGroupAffected_encode_uper,
	ResponderGroupAffected_decode_aper,
	ResponderGroupAffected_encode_aper,
