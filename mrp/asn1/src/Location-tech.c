...
asn_enc_rval_t
Location_tech_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	Location_tech_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
Location_tech_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	Location_tech_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_Location_tech_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  4,  4,  0l,  9l }	/* (0..9,...) */,
...
asn_TYPE_descriptor_t asn_DEF_Location_tech = {
	...
	Location_tech_decode_aper,
	Location_tech_encode_aper,
