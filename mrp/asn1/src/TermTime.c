...
asn_dec_rval_t
TermTime_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TermTime_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TermTime_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	TermTime_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
TermTime_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	TermTime_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_TermTime_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 11,  11,  1l,  1800l }	/* (1..1800) */,
...
asn_TYPE_descriptor_t asn_DEF_TermTime = {
	...
	TermTime_decode_xer,
	TermTime_encode_xer,
	TermTime_decode_uper,
	TermTime_encode_uper,
	TermTime_decode_aper,
	TermTime_encode_aper,
