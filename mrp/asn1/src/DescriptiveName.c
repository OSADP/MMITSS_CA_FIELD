...
asn_enc_rval_t
DescriptiveName_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	DescriptiveName_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
DescriptiveName_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	DescriptiveName_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_DescriptiveName_constr_1 GCC_NOTUSED = {
	...
	{ APC_CONSTRAINED,	 6,  6,  1l,  63l }	/* (SIZE(1..63)) */,
...
asn_TYPE_descriptor_t asn_DEF_DescriptiveName = {
	...
	DescriptiveName_decode_aper,
	DescriptiveName_encode_aper,
