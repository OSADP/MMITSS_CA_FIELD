...
static asn_TYPE_member_t asn_MBR_regional_8[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_RegionalExtension_92P45,
...
static asn_TYPE_member_t asn_MBR_NodeAttributeSetXY_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_NodeAttributeSetXY_specs_1 = {
