...
asn_dec_rval_t
ThrottleConfidence_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ThrottleConfidence_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
ThrottleConfidence_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	ThrottleConfidence_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
ThrottleConfidence_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	ThrottleConfidence_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_ThrottleConfidence_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_ThrottleConfidence_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ThrottleConfidence = {
	...
	ThrottleConfidence_decode_uper,
	ThrottleConfidence_encode_uper,
	ThrottleConfidence_decode_aper,
	ThrottleConfidence_encode_aper,
