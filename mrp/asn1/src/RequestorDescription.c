...
static asn_TYPE_member_t asn_MBR_regional_10[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_RegionalExtension_92P50,
...
static asn_TYPE_member_t asn_MBR_RequestorDescription_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_RequestorDescription_specs_1 = {
