...
static asn_per_constraints_t asn_PER_type_ApproachOrLane_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0l,  1l }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ApproachOrLane_1[] = {
...
static asn_CHOICE_specifics_t asn_SPC_ApproachOrLane_specs_1 = {
