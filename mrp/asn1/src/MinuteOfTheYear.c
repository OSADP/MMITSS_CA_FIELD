...
asn_enc_rval_t
MinuteOfTheYear_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	MinuteOfTheYear_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
MinuteOfTheYear_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	MinuteOfTheYear_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_MinuteOfTheYear_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 20, -1,  0l,  527040l }	/* (0..527040) */,
...
asn_TYPE_descriptor_t asn_DEF_MinuteOfTheYear = {
	...
	MinuteOfTheYear_decode_aper,
	MinuteOfTheYear_encode_aper,
