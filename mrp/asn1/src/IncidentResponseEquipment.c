...
asn_enc_rval_t
IncidentResponseEquipment_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	IncidentResponseEquipment_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
IncidentResponseEquipment_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	IncidentResponseEquipment_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_IncidentResponseEquipment_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  7,  7,  0l,  71l }	/* (0..71,...) */,
...
static const asn_INTEGER_specifics_t asn_SPC_IncidentResponseEquipment_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_IncidentResponseEquipment = {
	...
	IncidentResponseEquipment_decode_aper,
