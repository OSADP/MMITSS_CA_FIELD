...
asn_dec_rval_t
TermDistance_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TermDistance_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TermDistance_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	TermDistance_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
TermDistance_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	TermDistance_1_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}

static asn_per_constraints_t asn_PER_type_TermDistance_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 15,  15,  1l,  30000l }	/* (1..30000) */,
...
asn_TYPE_descriptor_t asn_DEF_TermDistance = {
	...
	TermDistance_decode_uper,
	TermDistance_encode_uper,
	TermDistance_decode_aper,
	TermDistance_encode_aper,
