...
asn_enc_rval_t
Acceleration_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	Acceleration_1_inherit_TYPE_descriptor(td);
...
asn_dec_rval_t
Acceleration_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	Acceleration_1_inherit_TYPE_descriptor(td);
...
static asn_per_constraints_t asn_PER_type_Acceleration_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 12,  12, -2000l,  2001l }	/* (-2000..2001) */,
